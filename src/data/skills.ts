...
const tech = (name: string, icon: IconType, color: string): Tech => ({
  name,
  icon,
  color,
})
...
export const skillCategories: SkillCategory[] = [
  {
    ...
    techs: [
      ...
      tech('Next.js', SiNextdotjs, '#000000'),
  ...
  },
  {
    label: 'Backend',
    techs: [
      tech('Node.js', SiNodedotjs, '#339933'),
      tech('Express', SiExpress, '#000000'),
      tech('Prisma', SiPrisma, '#2D3748'),
    ],
  },
  {
    label: 'Databases',
    techs: [
      ...
      tech('PostgreSQL', SiPostgresql, '#4169E1'),
    ],
  },
  {
    label: 'Languages',
